...
function addClosingPage(doc: PdfDocument, result: ScoreResult, narrative: ResultNarrative) {
  ...
  addLabel(doc, 'Em preparação', 26, y + 12)
  doc.setFont('helvetica', 'bold')
  doc.setFontSize(15)
  doc.setTextColor(...colors.graphite)
  doc.text('E-book PráxIA', 26, y + 27)
  addWrappedText(doc, 'Um aprofundamento prático alinhado ao seu resultado estará disponível futuramente.', 26, y + 38, 67, 8.8, 4.3)
  doc.setFillColor(...colors.pale)
  doc.roundedRect(108, y, 84, 58, 4, 4, 'F')
  addLabel(doc, 'Em preparação', 116, y + 12)
  doc.setFont('helvetica', 'bold')
  doc.setFontSize(15)
  doc.setTextColor(...colors.graphite)
  doc.text('Mentoria individual', 116, y + 27)
  addWrappedText(doc, 'Uma sessão para aplicar IA a um desafio real da prática será oferecida futuramente.', 116, y + 38, 67, 8.8, 4.3)
  y += 78
