...
export function CertificatesAdminPage() {
  ...
  return <CmsAdminLayout user={user}><header className="cms-page-header"><div><p className="eyebrow eyebrow--dark"><span />Credenciais PráxIA</p><h1>Certificados</h1><p>Emita, baixe e acompanhe certificados do workshop.</p></div></header>
