...
export function CmsPublicArticlePage({ preview = false }: { preview?: boolean }) {
  ...
  return <>
    <Seo title={preview ? `Prévia: ${view.title} | PráxIA` : view.seoTitle} description={view.metaDescription} path={view.path} type="article" image={view.socialImage} imageAlt={view.socialImageAlt} robots={preview ? 'noindex, nofollow' : 'index, follow'} jsonLd={{ '@context': 'https://schema.org', '@graph': graph }} />
