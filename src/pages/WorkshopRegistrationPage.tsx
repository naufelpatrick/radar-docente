...
export function WorkshopRegistrationPage() {
  ...
  return <div className="workshop-page workshop-registration-page">
    ...
    <main id="conteudo-inscricoes">
      ...
      <section className="workshop-radar-cta" aria-labelledby="radar-workshop"><div className="workshop-shell workshop-radar-cta__grid"><div><p className="workshop-kicker">CONHEÇA SEU PONTO DE PARTIDA</p><h2 id="radar-workshop">Faça o Radar PráxIA antes do workshop.</h2><p>Em aproximadamente oito minutos, receba uma leitura gratuita da sua fluência digital e em IA: score, seis dimensões, forças, pontos de atenção e um próximo passo possível.</p></div><a href="/radar-docente">FAZER O DIAGNÓSTICO GRATUITO<ArrowRight aria-hidden="true" /></a></div></section>
