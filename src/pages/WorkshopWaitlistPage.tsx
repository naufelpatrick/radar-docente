...
import { ArrowRight, BookOpen, Instagram, Layers3, LineChart, Linkedin, Quote } from 'lucide-react'
...
export function WorkshopWaitlistPage({ registered = false }: Props) {
  ...
  return (
    <div className="workshop-page">
      <Seo title={registered ? 'Interesse registrado | Workshop PráxIA' : 'Workshop gratuito: IA na prática docente | PráxIA'} description={registered ? 'Seu interesse no workshop IA na prática docente foi registrado.' : 'Entre na lista de espera do workshop gratuito sobre fluência em IA, maturidade digital e aplicação prática no planejamento docente.'} path={registered ? '/lp/workshop-ia-2026/inscrito' : '/lp/workshop-ia-2026'} robots={registered ? 'noindex, follow' : undefined} image="https://www.radarpraxia.com/social/workshop-ia-pratica-docente-1200x630.jpg" imageAlt="Educadores reunidos em torno de um computador durante atividade de formação" />
      ...
      <main id="conteudo-workshop">
        ...
        {interestRegistered && <section className="workshop-next-step" aria-labelledby="proximo-passo-workshop">
          <div className="workshop-shell workshop-next-step__grid">
            <div>
              <p className="workshop-kicker">CONHEÇA SEU PONTO DE PARTIDA</p>
              <h2 id="proximo-passo-workshop">Antes do workshop, realize o <em>Diagnóstico PráxIA.</em></h2>
            </div>
            <div className="workshop-next-step__actions">
              <p>Uma leitura gratuita da sua fluência digital e em IA, com forças, pontos de atenção e um próximo passo possível para a prática docente.</p>
              <div>
                <a className="workshop-next-step__primary" href="/radar-docente">Realizar o Diagnóstico <ArrowRight aria-hidden="true" /></a>
                <a className="workshop-next-step__secondary" href="/">Conhecer o site PráxIA <ArrowRight aria-hidden="true" /></a>
              </div>
            </div>
          </div>
        </section>}
