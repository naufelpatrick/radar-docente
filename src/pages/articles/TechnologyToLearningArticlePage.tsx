  ...
  return (
    <>
      ...
      <ArticleLayout article={article} categoryPath="/blog/categoria/planejamento" toc={toc}>
        ...
        <section className="article-cta"><h2>Seu planejamento parte da ferramenta ou da aprendizagem?</h2><p>Reconheça como você decide, planeja, avalia e conduz o uso de IA em sua prática.</p><ButtonLink href="/radar" variant="light" showArrow>Descobrir meu Score PraxIA</ButtonLink></section>
