...
insert into public.cms_editorial_settings (key, value) values
  ...
  ('default_cta', '{"title":"Descubra como essas decisões aparecem na sua prática","text":"O Radar Docente da PraxIA ajuda a reconhecer forças e oportunidades de desenvolvimento.","label":"Fazer meu Radar Docente","href":"/radar"}'::jsonb),
  ('publisher', '{"name":"PraxIA","url":"https://www.radarpraxia.com/","logo":"https://www.radarpraxia.com/favicon.png"}'::jsonb),
